			...
			<div class="pd-ltr-20 xs-pd-20-10">
				...
				<div class="card-box mb-30" style="width: 100%;left:3rm;">
						<div class="pd-20 pb-10 d-flex justify-content-center">
							<h4 class="text h4">View Payslip</h4>
                        </div>
				...
				ob_end_flush();
					...
					<div class="form-group">
						...
						<div class="col-sm-12 col-md-12">
						<input type="text" name="username" value="<?php echo $oldusername;?>" class="form-control" required>
						</div>
						</div>
						...
						<div class="col-sm-6" style="right:3rem;bottom:.5rem;">
						<button class="btn btn-success" name="update_profile">Save Profile</button>

						</div>
						<div class="col-sm-4" style="left:18rem;bottom:3.3rem;">
						
						<a href="test.php"><button type="button" class="btn btn-warning">Change Password</button></a>
          				</div>
