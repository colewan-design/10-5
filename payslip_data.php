			...
			<div class="pd-ltr-20 xs-pd-20-10">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <option  class="btn-sm" target="_blank"  value="mpdf.php?edit=<?php echo $row['id']; ?>" data-content="<i class='fas fa-eye' aria-hidden='true'></i>View">View</option>
                            
						<option  class="btn-sm"  value="payslip_download.php?edit=<?php echo $row['id']; ?>" data-content="<i class='fas fa-download' aria-hidden='true'></i>Download">Download</option>
