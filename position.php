...
<p></p>
		...
		<div class="main-container">
            ...
            ?>
						...
						<button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#add-Position">Add Position</button>
						</div>
							...
							<div class="modal fade" id="add-Position" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
									<div class="modal-dialog modal-dialog-centered">
										<div class="modal-content">
											<div style="background:	#F08080;" class="modal-header">
											...
											<div class="modal-body">
												<form action="process.php" method="POST">
													<div class="form-group">
														<label class="col-sm-12 col-md-4 col-form-label">Position Name</label>
														<div class="col-sm-12 col-md-10">
															<input name="positionName"  class="form-control" type="text" placeholder="Enter New Employee Position" required>
														</div>
													</div>
                 
													
                                                    <div>
                                                    <button style="margin-left: 1rem;" type="submit" name="insertPosition" class="btn btn-primary">
													Save changes
												    </button>
                            ...
                            <table class="table table-striped table-bordered">
                              ...
                              <tbody>
								...
								<tr>
									...
									<td align="center">
										<a href="process.php?positionDelete=<?php echo $row['positionId']; ?>">
